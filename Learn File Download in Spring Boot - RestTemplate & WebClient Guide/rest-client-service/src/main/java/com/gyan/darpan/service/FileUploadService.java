...
public class FileUploadService {
    ...
    public void downloadFileFromInputStream() {
        String resourceUrl = "download/file/{fileName}";

        Map<String, Object> pathVariables = new HashMap<>();
        pathVariables.put("fileName", "springboot.png");

        ResponseEntity<InputStreamResource> responseEntity = restWebClient.execute(baseUrl, resourceUrl, InputStreamResource.class, null,
                null, HttpMethod.GET, pathVariables, null);
