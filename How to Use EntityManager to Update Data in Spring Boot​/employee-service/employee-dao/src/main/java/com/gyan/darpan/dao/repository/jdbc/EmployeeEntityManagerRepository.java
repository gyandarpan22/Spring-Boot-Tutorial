...
//        return new PageResponse<>(employees, pageNumber, pageSize, totalEmployees);
    ...
    public Employee updateEmployee(Employee employee) {
      ...
      /*
        ...
        Root<Employee> root = criteriaUpdate.getRoot();

        criteriaUpdate.set(root.get("employeeName"), employee.getEmployeeName());
        criteriaUpdate.set(root.get("age"), employee.getAge());
        criteriaUpdate.set(root.get("department"), employee.getDepartment());

        criteriaUpdate.where(criteriaBuilder.equal(root.get("employeeId"), employee.getEmployeeId()));

        int updateCount = entityManager.createQuery(criteriaUpdate)
                .executeUpdate();
